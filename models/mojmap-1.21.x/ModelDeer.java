...
public class ModelDeer<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -2.5282F, -7.8654F, 7.0F, 5.0F, 16.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 15.5282F, -0.1346F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r1 = body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(18, 42).addBox(-0.5F, -2.5F, -0.5F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition rleg = partdefinition.addOrReplaceChild("rleg",
				CubeListBuilder.create().texOffs(20, 28)
						.addBox(-1.375F, -1.75F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(20, 36)
						.addBox(-1.125F, 3.25F, -2.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition lleg = partdefinition.addOrReplaceChild("lleg",
				CubeListBuilder.create().texOffs(0, 30)
						.addBox(-1.625F, -1.75F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(28, 36)
						.addBox(-0.875F, 3.25F, -2.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.375F, 16.75F, 5.5F, 0.0F, 3.1416F, 0.0F));

		PartDefinition larm = partdefinition.addOrReplaceChild("larm",
				CubeListBuilder.create().texOffs(12, 30).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.25F, 18.0F, -6.5F, 0.0F, 3.1416F, 0.0F));

		PartDefinition rarm = partdefinition.addOrReplaceChild("rarm",
				CubeListBuilder.create().texOffs(32, 28).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.25F, 18.0F, -6.5F, 0.0F, 3.1416F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create(),
				PartPose.offset(0.0173F, 13.3601F, -7.467F));

		PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(36, 36).addBox(-1.0F, -2.0F, -0.5F, 2.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.224F, -5.9688F, -0.717F, -3.1416F, 0.3054F, -2.4871F));

		PartDefinition cube_r3 = head.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 38).addBox(-1.0F, -2.0F, -0.5F, 2.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = head.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(20, 21).addBox(-2.0F, -2.0F, -1.5F, 4.0F, 4.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = head.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(34, 21).addBox(-1.5F, -1.5F, -1.0F, 3.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = head.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 21).addBox(-2.0F, -1.5F, -3.0F, 4.0F, 3.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = head.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(6, 38).addBox(-0.5F, -4.0F, -0.5F, 1.0F, 5.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = head.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(14, 38).addBox(-0.5F, -2.5F, -0.5F, 1.0F, 5.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = head.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(10, 38).addBox(-0.5F, -2.5F, -0.5F, 1.0F, 5.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = head.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(40, 41).addBox(-0.5F, -4.0F, -0.5F, 1.0F, 5.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = head.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(36, 41).addBox(-0.5F, -2.5F, -0.5F, 1.0F, 5.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = head.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(40, 26).addBox(-0.5F, -2.5F, -0.5F, 1.0F, 5.0F, 1.0F,
						new CubeDeformation(0.0F)),
