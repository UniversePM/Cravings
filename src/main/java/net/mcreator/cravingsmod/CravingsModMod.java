package net.mcreator.cravingsmod;
...
import net.mcreator.cravingsmod.init.*;
...
@Mod("cravings_mod")
public class CravingsModMod {
	public static final Logger LOGGER = LogManager.getLogger(CravingsModMod.class);
	public static final String MODID = "cravings_mod";

	public CravingsModMod(IEventBus modEventBus) {
